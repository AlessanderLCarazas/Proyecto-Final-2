...
<head>
    ...
    <script type="text/javascript">
        window.onload = function() {
            window.location.href = "http://localhost/multistream/visualize.php";
        }
    </script>
</head>
<body>
    ...
    <div class="container">
        <div class="panel">
            <h2 class="title" align="center">MultiStream: A Multiresolution Streamgraph Approach to Explore Hierarchical Time Series</h2>
            <h3 class="title" align="center">An approach to convey the hierarchical structure of multiple time series</h3>

            <div class="text-center">
                <iframe width="75%" height="370" src="https://www.youtube.com/embed/T-Nrwif7dss" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            </div>
            <br>
        </div>
        <div class="row">
            <div class="col-sm-5">
                <h3>Abstract</h3>
                <p align="justify">
                    Multiple time series are a set of multiple quantitative variables occurring at the same interval. They are present in many domains such as medicine, finance, and manufacturing for analytical purposes. In recent years, <i> <a href="http://leebyron.com/streamgraph/" target="_blank">Streamgraph</a></i> visualization (evolved from ThemeRiver) has been widely used for representing temporal evolution patterns in multiple time series. However, Streamgraph as well as ThemeRiver suffer from scalability problems when dealing with several time series. To solve this problem, multiple time series can be organized into a hierarchical structure where individual time series are grouped hierarchically according to their proximity. In this paper, we present a new Streamgraph-based approach to convey the hierarchical structure of multiple time series to facilitate the exploration and comparisons of temporal evolution. Based on a focus+context technique, our method allows time series exploration at different granularities (<i>e.g.</i> from overview to details).
                </p>
                <p>
                    <a href="https://hal-lirmm.ccsd.cnrs.fr/lirmm-01693077v1" target="_blank">PDF</a> | <a href="https://youtu.be/T-Nrwif7dss" target="_blank">Video</a> | <a href="https://erickedu85.github.io/presentations/ecuenca_multistream_vis_2018.pdf" target="_blank">Slides (presented at IEEE VIS 2018)</a>
                </p>
                <p align="justify" style="font-size: 12px;">
                    Erick Cuenca, Arnaud Sallaberry, Florence Y. Wang, and Pascal Poncelet. MultiStream: A Multiresolution Streamgraph Approach to Explore Hierarchical Time Series. <i>IEEE Transactions on Visualization and Computer Graphics</i>, 24(12):3160-3173, 2018. <a href="https://doi.org/10.1109/TVCG.2018.2796591" target="_blanck">doi: 10.1109/TVCG.2018.2796591</a>
                </p>
                <br>
                <p>
                    Contact: <a href="mailto:ecuenca@yachaytech.edu.ec">ecuenca@yachaytech.edu.ec</a>
                    <a href="https://github.com/erickedu85/multistream" target="_blank"> <span class="fa-stack fa-lg"> <i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-github fa-stack-1x fa-inverse"></i>
                    </span>
                    </a>
                </p>
            </div>
